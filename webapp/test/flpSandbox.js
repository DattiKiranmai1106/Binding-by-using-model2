		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapktbindingbindingbyusingmodel2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapktbindingbindingbyusingmodel2-display": {
								"semanticObject": "comsapktbindingbindingbyusingmodel2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.kt.binding.bindingbyusingmodel2",
									"url": sap.ui.require.toUrl("com/sap/kt/binding/bindingbyusingmodel2")
								}
							}
						}
					}
